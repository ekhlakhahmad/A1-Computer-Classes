				...
				<div className="FacilitiesBox">
					<div>
						<img
							...
							alt="course"
						/>
						<p className="coursePara">CCTV Camara in Classroom</p>
					</div>
					<div>
						<img
							...
							alt="course"
						/>
						<p className="coursePara">Theory Classroom</p>
					</div>
					<div>
						<img
							...
							alt="course"
						/>
						<p className="coursePara">Practical Classroom</p>
					</div>
					<div>
						<img
							...
							alt="course"
						/>
						<p className="coursePara">Waiting Room</p>
					</div>
				</div>
			</div>
		</div>
